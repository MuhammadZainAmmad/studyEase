...
const Footer = () => {
    return (
        <div className='footer container-fluid bg-dark mt-3 pt-3'>
            <div className='row'>
                <div className='col-6'>
            ...
            <div className="row bg-secondary " >
                    <p className='text-light text-end pt-2'>Copyright <i class="fa fa-copyright" aria-hidden="true"></i> 2022 Study-Ease</p>
